...
exports.webkit = exports.gecko = exports.blink = void 0;
...
const webkit = exports.webkit = typeof CSS !== 'undefined' && !!CSS.supports?.('-webkit-backdrop-filter:none');
...
/** Gecko: Firefox. */
const gecko = exports.gecko = !webkit && _shared.lowerUserAgent.includes('firefox');
...
const blink = exports.blink = !webkit && _shared.lowerUserAgent.includes('chrom');