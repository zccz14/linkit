import { MenuStore, type MenuHandleStore } from "./MenuStore.mjs";
 ...
 */
export declare class MenuHandle<Payload> extends BasePopupHandle<MenuHandleStore<Payload>, MenuStore<Payload>> {
  constructor();
  /**
