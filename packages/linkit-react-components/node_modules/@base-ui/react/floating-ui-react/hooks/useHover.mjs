...
import { contains, getTarget, isInteractiveElement } from "../utils/element.mjs";
import { getDelay, getRestMs, isClickLikeOpenEvent as isClickLikeOpenEventShared, isHoverOpenEvent } from "./useHoverShared.mjs";
/**
...
export function useHover(context, props = {}) {
  ...
  React.useEffect(() => {
    ...
    if (isElement(trigger)) {
      ...
      return mergeCleanups(open && addEventListener(trigger, 'mouseleave', onScrollMouseLeave), move && addEventListener(trigger, 'mousemove', onReferenceMouseEnter, {
        once: true
