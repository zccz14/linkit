...
export interface ContextMenuRootProps extends Omit<Menu.Root.Props, 'handle' | 'triggerId' | 'defaultTriggerId' | 'modal' | 'openOnHover' | 'delay' | 'closeDelay' | 'onOpenChange' | 'children'> {
  /**
