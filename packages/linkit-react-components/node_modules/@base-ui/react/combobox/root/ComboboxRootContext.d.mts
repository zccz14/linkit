...
import { ComboboxStore } from "../store.mjs";
...
export declare const ComboboxFloatingContext: React.Context<import("../../floating-ui-react/components/FloatingRootStore.mjs").FloatingRootStore | undefined>;
export declare const ComboboxDerivedItemsContext: React.Context<ComboboxDerivedItemsContext | undefined>;
export declare const ComboboxHasItemsContext: React.Context<boolean>;
...
export declare function useComboboxFloatingContext(): import("../../floating-ui-react/components/FloatingRootStore.mjs").FloatingRootStore;
...
export declare function useComboboxHasItemsContext(): boolean;