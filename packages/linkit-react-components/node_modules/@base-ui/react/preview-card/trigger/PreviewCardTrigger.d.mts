...
import { PreviewCardHandle } from "../store/PreviewCardHandle.mjs";
/**
...
export interface PreviewCardTriggerProps<Payload = unknown> extends BaseUIComponentProps<'a', PreviewCardTriggerState, React.ComponentPropsWithRef<'a'>> {
  /**
