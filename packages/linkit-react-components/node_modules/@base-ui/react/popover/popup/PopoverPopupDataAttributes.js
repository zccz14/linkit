...
let PopoverPopupDataAttributes = exports.PopoverPopupDataAttributes = function (PopoverPopupDataAttributes) {
   ...
   */
  PopoverPopupDataAttributes[PopoverPopupDataAttributes["side"] = _popupStateMapping.CommonPopupDataAttributes.side] = "side";
  /**
   * Indicates how the popup is aligned relative to specified side.
   * @type {'start' | 'center' | 'end'}
   */
  PopoverPopupDataAttributes[PopoverPopupDataAttributes["align"] = _popupStateMapping.CommonPopupDataAttributes.align] = "align";
  /**
