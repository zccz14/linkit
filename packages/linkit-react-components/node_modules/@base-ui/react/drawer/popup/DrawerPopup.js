...
const stateAttributesMapping = {
  ..._popupStateMapping.popupTransitionStateMapping,
  expanded(value) {
    return value ? {
...
const DrawerPopup = exports.DrawerPopup = /*#__PURE__*/React.forwardRef(function DrawerPopup(componentProps, forwardedRef) {
  ...
  const swipe = (0, _DrawerViewportContext.useDrawerViewportContext)();
  ...
  if (shouldApplySnapPoints && swipeDirection === 'down') {
    ...
    const movementValue = Number.parseFloat(String(dragStyles[_DrawerPopupCssVars.DrawerPopupCssVars.swipeMovementY]));
    if (swiping && Number.isFinite(movementValue)) {
      dragStyles = {
        ...dragStyles,
        transform: undefined,
        [_DrawerPopupCssVars.DrawerPopupCssVars.swipeMovementY]: `${(0, _useDrawerSnapPoints.getSnapPointSwipeMovement)(baseOffset, movementValue)}px`
      };
    } else {
      dragStyles = {
        ...dragStyles,
