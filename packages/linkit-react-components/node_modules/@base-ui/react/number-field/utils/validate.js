...
exports.hasNumberFormatRoundingOptions = hasNumberFormatRoundingOptions;
...
function removeFloatingPointErrors(value, format) {
  ...
  const formatter = (0, _formatNumber.getFormatter)('en-US', {
    ...format,
  ...
  const roundedValue = (0, _parse.parseNumber)(roundedText, 'en-US', format);
...
function toValidatedNumber(value, step, minWithDefault, maxWithDefault, minWithZeroDefault, format, snapOnStep, small, shouldClamp) {
  ...
  if (shouldClamp) {
    nextValue = (0, _clamp.clamp)(nextValue, minWithDefault, maxWithDefault);
  }
  ...
  return shouldClamp ? (0, _clamp.clamp)(roundedValue, minWithDefault, maxWithDefault) : roundedValue;
}