...
import { getFormatter } from "../../utils/formatNumber.mjs";
...
export function hasNumberFormatRoundingOptions(format) {
...
export function toValidatedNumber(value, step, minWithDefault, maxWithDefault, minWithZeroDefault, format, snapOnStep, small, shouldClamp) {
  if (value === null) {
    return value;
  }
  let nextValue = value;
