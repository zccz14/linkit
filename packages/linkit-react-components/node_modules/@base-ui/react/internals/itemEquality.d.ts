...
export declare function findSelectionIndex<Item, Value>(itemValues: readonly Item[] | undefined | null, selectedValue: Value | readonly Value[] | null | undefined, comparer: ItemEqualityComparer<Item, Value>, multiple: boolean): number | null;
