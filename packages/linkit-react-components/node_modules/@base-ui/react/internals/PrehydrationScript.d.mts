 ...
 */
export declare function PrehydrationScript(props: PrehydrationScript.Props): import("react/jsx-runtime").JSX.Element | null;
export declare namespace PrehydrationScript {
  interface Props {
    /**
