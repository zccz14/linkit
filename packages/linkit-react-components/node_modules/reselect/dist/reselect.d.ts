 ...
 * @internal
 */
type IfUnknown<T, TypeIfUnknown, TypeIfNotUnknown> = IsAny<T> extends true ? TypeIfNotUnknown : unknown extends T ? [keyof T] extends [never] ? TypeIfUnknown : TypeIfNotUnknown : TypeIfNotUnknown;
/**
