...
const english = {
  ...
  "conversation.groupAvatarHint":
    "This image appears on the group and in group Bark notifications.",
  ...
  "profileEditor.intro": "Introduction",
  ...
  "admin.resources": "System resources",
  "admin.resourcesDescription":
    "Live host resources for this Linkit instance. Refreshes every 5 seconds.",
  "admin.cpu": "CPU",
  "admin.cpuDetail": "Load 1m: {load} · {count} logical CPUs",
  "admin.memory": "Memory",
  "admin.memoryDetail":
    "Available: {available} · Swap: {swapUsed} / {swapTotal}",
  "admin.network": "Network",
  "admin.networkDetail":
    "{count} interfaces · Total: ↓ {received} · ↑ {transmitted}",
  "admin.disk": "Disk",
  "admin.diskDetail": "Available: {available} · Mount: {mountPoint}",
  "admin.sqlite": "SQLite",
  "admin.sqliteDetail": "Main: {main} · WAL: {wal} · SHM: {shm}",
  "admin.resourceUnavailable": "Resource data is unavailable.",
...
const chinese: Record<TranslationKey, string> = {
  ...
  "admin.resources": "系统资源",
  "admin.resourcesDescription": "此 Linkit 实例的实时主机资源，每 5 秒刷新。",
  "admin.cpu": "CPU",
  "admin.cpuDetail": "1 分钟负载：{load} · {count} 个逻辑 CPU",
  "admin.memory": "内存",
  "admin.memoryDetail":
    "可用：{available} · 交换分区：{swapUsed} / {swapTotal}",
  "admin.network": "网络",
  "admin.networkDetail":
    "{count} 个网卡 · 累计：↓ {received} · ↑ {transmitted}",
  "admin.disk": "磁盘",
  "admin.diskDetail": "可用：{available} · 挂载点：{mountPoint}",
  "admin.sqlite": "SQLite",
  "admin.sqliteDetail": "主文件：{main} · WAL：{wal} · SHM：{shm}",
  "admin.resourceUnavailable": "资源数据不可用。",
